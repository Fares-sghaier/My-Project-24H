...
import Foodlist from "../Navbar/Foodlist.jsx";
export default class Adminwork extends React.Component {
  ...
  handleClick() {
    ...
    axios
      .post("/post/list", { price: price, image: image, name: name })
      .then((data) => {
        this.fetchdata();
        this.setState({ list: data.list });
      })
      .catch((err) => {
        console.log(err, "YOU HAVE AN ERROR IN POST REQUEST");
      });
  }
   handleDelete(id) {
     console.log(id);
        ...
        <div className="container">
          <section className="order" id="order">
            <div className="row">
              ...
              <form action="">
                <h1 className="heading">Put a new food</h1>
                  ...
                  <section className="popular" id="popular">
                    ...
                    <div className="box-container">
                      <div className="box">
                        ...
                        <h3>{elem.name}</h3>
                        <button href="#" className="bota" onClick={()=>{this.handleDelete(elem._id)}}>
                          Delete the Post
                        </button>
                      </div>
                    </div>
